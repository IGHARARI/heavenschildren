...
import theHeavensChild.cards.*;
import theHeavensChild.relics.TodoItem;

import java.util.ArrayList;
import java.util.List;

import static theHeavensChild.TheHeavensChild.Enums.HEAVENSCHILD_COLOR;
import static theHeavensChild.HeavensChildMod.*;

public class TheHeavensChild extends CustomPlayer {
    ...
    public TheHeavensChild(String name, PlayerClass setClass) {
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(OverheadSmash.ID);
        retVal.add(PullThrough.ID);
        retVal.add(Counterbalance.ID);
        return retVal;
    }
    ...
    public AbstractPlayer newInstance() {
        return new TheHeavensChild(name, chosenClass);
    }
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_HEAVENSCHILD;
        @SpireEnum(name = "HEAVENSCHILD_COLOR")
        public static AbstractCard.CardColor HEAVENSCHILD_COLOR;
        @SpireEnum(name = "HEAVENSCHILD_COLOR")
