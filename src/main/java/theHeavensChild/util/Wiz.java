...
import theHeavensChild.actions.TimedVFXAction;
import theHeavensChild.powers.LosePowerPower;
...
public class Wiz {
    ...
    public static void shuffleIn(AbstractCard c, int i) {
        addToBot(new MakeTempCardInDrawPileAction(c, i, true, true));
    }
    ...
    public static void applyToSelfTemp(AbstractPower po) {
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, po, po.amount));
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new LosePowerPower(AbstractDungeon.player, po, po.amount)));
    }

    public static void applyToSelfNextTurn(AbstractPower po) {
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new NextTurnPowerPower(AbstractDungeon.player, po)));
    }
